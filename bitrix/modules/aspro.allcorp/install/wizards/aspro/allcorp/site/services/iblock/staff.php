...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		'tabs' => 'edit1--#--'.GetMessage("WZD_IBLOCK_STAFF").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_ACTIVE").'--,--NAME--#--'.GetMessage("WZD_OPTION_NAME_").'--,--CODE--#--'.GetMessage("WZD_OPTION_CODE").'--,--SORT--#--'.GetMessage("WZD_OPTION_SORT").'--,--PROPERTY_'.$arProperty["POST"].'--#--'.GetMessage("WZD_OPTION_PROP_POST").'--,--PROPERTY_'.$arProperty["PHONE"].'--#--'.GetMessage("WZD_OPTION_PROP_PHONE").'--,--PROPERTY_'.$arProperty["EMAIL"].'--#--'.GetMessage("WZD_OPTION_PROP_EMAIL").'--;--edit5--#--'.GetMessage("WZD_PREVIEW").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_PREVIEW_PICTURE").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_PREVIEW_TEXT").'--;--edit6--#--'.GetMessage("WZD_DETAIL").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_DETAIL_PICTURE").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_DETAIL_TEXT").'--;--edit14--#--'.GetMessage("WZD_SEO").'--,'.GetMessage("WZD_OPTION_SEOALL").';--edit2--#--'.GetMessage("WZD_SECTIONS").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_SECTIONS").'--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,PREVIEW_PICTURE,PROPERTY_'.$arProperty["POST"].',PROPERTY_'.$arProperty["PHONE"].',PROPERTY_'.$arProperty["EMAIL"].',ACTIVE,SORT,ID', 'by' => 'sort', 'order' => 'desc', 'page_size' => '20', 
	));
}
