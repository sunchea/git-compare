...
$APPLICATION->SetTitle("Визуальные элементы");?><div class="row">
						<div class="col-md-6">
...
<pre>
	...
	&lt;/div&gt;
							...
							<h2 class="short">Accordion type 2</h2>
...
<pre>
	...
	&lt;/div&gt;
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<button class="demo-modal btn btn-primary btn-lg pull-top" data-event="jqm" data-id="20" data-autoload-FIO="Example auto name" data-autohide="location.reload()">
								Launch demo modal
							</button>
  ...
  <div class="col-md-12"> 							 
   ...
   Исходный код: 
    <pre>&lt;div class=&quot;styled-block&quot;&gt;Красивый блок на сайте&lt;/div&gt;</pre>
