...
$arFormsShortCODE = array("example", "order_project", "order_product", "order_services", "resume", "question", "callback");
foreach($arFormsShortCODE as $iblockShortCODE){
	...
	$iblockTYPE = "aspro_allcorp_form";
	$iblockXMLID = "aspro_allcorp_form_".$iblockShortCODE."_".WIZARD_SITE_ID;
	...
	if(WIZARD_INSTALL_DEMO_DATA){
		...
		//CUserOptions::SetOption("form", "form_element_".$iblockID, array(
			//'tabs' => 'edit1--#--'.GetMessage("WZD_IBLOCK_PROJECT").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_ACTIVE").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_ACTIVE_FROM").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_ACTIVE_TO").'--,--NAME--#--'.GetMessage("WZD_OPTION_NAME_").'--,--CODE--#--'.GetMessage("WZD_OPTION_CODE").'--,--SORT--#--'.GetMessage("WZD_OPTION_SORT").'--,--PROPERTY_'.$arProperty["FORM_PROJECT"].'--#--'.GetMessage("WZD_OPTION_PROP_FORM_PROJECT").'--,--PROPERTY_'.$arProperty["PROJECT_S"].'--#--'.GetMessage("WZD_OPTION_PROP_PROJECT_S").'--,--PROPERTY_'.$arProperty["PROJECT_TYPE"].'--#--'.GetMessage("WZD_OPTION_PROP_PROJECT_TYPE").'--,--PROPERTY_'.$arProperty["ORDERER"].'--#--'.GetMessage("WZD_OPTION_PROP_ORDERER").'--,--PROPERTY_'.$arProperty["SITE"].'--#--'.GetMessage("WZD_OPTION_PROP_SITE").'--;--edit5--#--'.GetMessage("WZD_PREVIEW").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_PREVIEW_PICTURE").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_PREVIEW_TEXT").'--;--edit6--#--'.GetMessage("WZD_DETAIL").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_DETAIL_PICTURE").'--,--PROPERTY_'.$arProperty["PHOTOS"].'--#--'.GetMessage("WZD_OPTION_PROP_PHOTOS").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_DETAIL_TEXT").'--;--cedit1--#--'.GetMessage("WZD_LINKS").'--,--PROPERTY_'.$arProperty["LINK_PROJECTS"].'--#--'.GetMessage("WZD_OPTION_PROP_LINK_PROJECTS").'--;--edit14--#--'.GetMessage("WZD_SEO").'--,'.GetMessage("WZD_OPTION_SEOALL").';--edit2--#--'.GetMessage("WZD_SECTIONS").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_SECTIONS").'--;--',
		//));
		
		// list user options
		CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
			'columns' => 'NAME,ACTIVE,SORT,TIMESTAMP_X,ID', 'by' => 'date_active_from', 'order' => 'desc', 'page_size' => '20', 
		));
	}
