...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		'tabs' => 'edit1--#--'.GetMessage("WZD_IBLOCK_FAQ").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_ACTIVE").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_ACTIVE_FROM").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_ACTIVE_TO").'--,--NAME--#--'.GetMessage("WZD_OPTION_M_QUESTION_").'--,--CODE--#--'.GetMessage("WZD_OPTION_CODE").'--,--SORT--#--'.GetMessage("WZD_OPTION_SORT").'--,--PROPERTY_'.$arProperty["TITLE_BUTTON"].'--#--'.GetMessage("WZD_OPTION_PROP_TITLE_BUTTON").'--,--PROPERTY_'.$arProperty["LINK_BUTTON"].'--#--'.GetMessage("WZD_OPTION_PROP_LINK_BUTTON").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_DETAIL_PICTURE").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_M_ANSWER").'--;--edit2--#--'.GetMessage("WZD_SECTIONS").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_SECTIONS").'--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,ACTIVE,SORT,TIMESTAMP_X,ID', 'by' => 'sort', 'order' => 'asc', 'page_size' => '20', 
	));
}
