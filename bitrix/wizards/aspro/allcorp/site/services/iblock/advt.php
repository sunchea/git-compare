...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		'tabs' => 'edit1--#--'.GetMessage("WZD_IBLOCK_ADVT").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_ACTIVE").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_ACTIVE_FROM").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_ACTIVE_TO").'--,--NAME--#--'.GetMessage("WZD_OPTION_NAME_").'--,--CODE--#--'.GetMessage("WZD_OPTION_CODE").'--,--SORT--#--'.GetMessage("WZD_OPTION_SORT").'--,--PROPERTY_'.$arProperty["LINKIMG"].'--#--'.GetMessage("WZD_OPTION_PROP_LINKIMG").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_M_FIMAGE").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_M_BIMAGE").'--,--PROPERTY_'.$arProperty["BANNERTYPE"].'--#--'.GetMessage("WZD_OPTION_PROP_BANNERTYPE").'--,--PROPERTY_'.$arProperty["TEXTCOLOR"].'--#--'.GetMessage("WZD_OPTION_PROP_TEXTCOLOR").'--,--PROPERTY_'.$arProperty["BUTTON1CLASS"].'--#--'.GetMessage("WZD_OPTION_PROP_BUTTON1CLASS").'--,--PROPERTY_'.$arProperty["BUTTON1TEXT"].'--#--'.GetMessage("WZD_OPTION_PROP_BUTTON1TEXT").'--,--PROPERTY_'.$arProperty["BUTTON1LINK"].'--#--'.GetMessage("WZD_OPTION_PROP_BUTTON1LINK").'--,--PROPERTY_'.$arProperty["BUTTON2CLASS"].'--#--'.GetMessage("WZD_OPTION_PROP_BUTTON2CLASS").'--,--PROPERTY_'.$arProperty["BUTTON2TEXT"].'--#--'.GetMessage("WZD_OPTION_PROP_BUTTON2TEXT").'--,--PROPERTY_'.$arProperty["BUTTON2LINK"].'--#--'.GetMessage("WZD_OPTION_PROP_BUTTON2LINK").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_PREVIEW_TEXT").'--;--edit2--#--'.GetMessage("WZD_SECTIONS").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_SECTIONS").'--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,PREVIEW_PICTURE,DETAIL_PICTURE,PROPERTY_'.$arProperty["LINKIMG"].',ACTIVE,SORT,TIMESTAMP_X,ID', 'by' => 'sort', 'order' => 'asc', 'page_size' => '20', 
	));
}

if ($iblockID){
	// replace macros IBLOCK_TYPE & IBLOCK_ID & IBLOCK_CODE
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_ADVT_TYPE" => $iblockTYPE));
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_ADVT_ID" => $iblockID));
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_ADVT_CODE" => $iblockCODE));
}
?>