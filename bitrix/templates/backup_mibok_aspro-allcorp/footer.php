<?IncludeTemplateLangFile(__FILE__);?>	
		...
		"PAGER_SHOW_ALL" => "N",
		"AJAX_OPTION_ADDITIONAL" => "",
		"MIBOK_SPECIAL_KEY" => "7106ad3c30c62880f43281827e3add8a"));?></div><div class="bs-docs-section"><?$APPLICATION->IncludeComponent("bitrix:news.list", "catalog-main", Array("PARENT_SECTION" => "0",
		"COUNT_IN_LINE" => "4",
		"VIEW_TYPE" => "table",
		"SHOW_TABS" => "",
		"SHOW_NAME" => "Y",
