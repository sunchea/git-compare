...
<?
$arItems = aspro::cacheElement(false, array( "SECTION_ID" => false, "ACTIVE" => "Y", "INCLUDE_SUBSECTIONS" => "Y", "IBLOCK_ID" => $arParams["IBLOCK_ID"], ), false, false, array("ID"));
$arSections = aspro::cacheSection(false, array( "IBLOCK_ID" => $arParams["IBLOCK_ID"], "SECTION_ID" => $arResult["VARIABLES"]["SECTION_ID"], "ACTIVE" => "Y" ), false, array("ID", "NAME"),true);
?>
...
<?}elseif($arItems){?>
	...
	$GLOBALS['arrFilters'] = array( "ID" => $arID);?>
	<?$APPLICATION->IncludeComponent(
		"bitrix:news.list",
		"catalog",
		Array(
