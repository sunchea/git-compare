			...
			foreach($arResult["ITEMS"] as $key=>$arItem)
			{
				...
				if(isset($arItem["PRICE"])):
					if (!$arItem["VALUES"]["MIN"]["VALUE"] || !$arItem["VALUES"]["MAX"]["VALUE"] || $arItem["VALUES"]["MIN"]["VALUE"] == $arItem["VALUES"]["MAX"]["VALUE"])
						continue;
					?>
						<div class="bx_filter_parameters_box test active <?=($arParams['FILTER_VIEW_MODE'] == 'HORIZONTAL' ? 'col-md-12 col-sm-12 col-xs-12' : 'col-md-12')?>">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<?php if($count_filter%5 === 0): ?>
						<div class="row_catalog" data-number="<?= ceil($count_filter/5+1) ?>">
							<div class="cells_bx_filter_parameters_box">
					<?php endif; ?>
					...
					<?php if($count_filter%5 == 4 || $count_filter+2 == $total_count_filter): ?>
							</div>
