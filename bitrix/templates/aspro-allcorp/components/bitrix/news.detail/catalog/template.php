...
<div class="catalog detail">
	<div class="row">
		<?if($arResult["GALLERY"] || $arResult["CONNECTION_SCHEME"]):?>
			<div class="col-md-4 item_slider">
				...
				<?endif;?>
				<?if($arResult["CONNECTION_SCHEME"]):?>
					<div class="connection_scheme">
						<img src="<?=$arResult["CONNECTION_SCHEME"]?>" />
					</div>
				<?endif;?>
			</div>
		<?endif;?>
		<div class="col-md-<?=($arResult["GALLERY"] ? '8' : '8');?> content">
						...
						<div class="char-wrapp">
							<table class="props_table">
								<?foreach($arResult["CHARACTERISTICS"] as $arProp):?>
										<?php
											$arrayPropDop = CIBlockSectionPropertyLink::GetArray($arResult['IBLOCK_ID'], $arResult['IBLOCK_SECTION_ID']);
										?>
									<tr class="char">
										<td class="char_name <?=$arProp['CLASSES'] ?>">

										<?php if($arrayPropDop[$arProp["ID"]]['FILTER_HINT']): ?>
											<span><?= $arrayPropDop[$arProp["ID"]]['FILTER_HINT'] ?></span><br>
										<?php endif; ?>
										...
										<td class="char_value <?=$arProp['CLASSES'] ?>">
											<span>
												<? /*
